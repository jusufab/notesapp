...
$result = mysqli_query($db, "SELECT * FROM profile_img WHERE user_id = $id2[id]");
    while ($row = mysqli_fetch_array($result)) {
		...
		echo "<img src='profileimg/".$row['profile_img']."' >";
...
<div class="or-seperator"><a href="profile.php">IMAGES</a><a href="notes.php">Notes</a></div>
<div class="center">
<?php
...
$id2 = $sqli->fetch();
$resultt = mysqli_query($db, "SELECT * FROM images WHERE user_id = $id2[id]");
    while ($rrow = mysqli_fetch_array($resultt)) {
        echo "<div class='galleryy'>";
      echo "<div class='gallery1' >";
      
      echo "<div id='imgscr' >";
          echo "<img src='userimages/".$rrow['image']."' >";
